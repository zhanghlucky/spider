...
public final class JavaBeanDescriptor implements Serializable, Iterable<Map.Entry<Object, Object>> {
    ...
    private static final String CLASS_PROPERTY_TYPE_NAME = "type_name";
    ...
    private String  classTypeNameProperty;
    ...
    public JavaBeanDescriptor(String className, int type) {
        ...
        this.type = type;
        if (isClassType()) {
            this.classTypeNameProperty=getClassTypeNameProperty();
        }

    }

    public JavaBeanDescriptor(JavaBeanDescriptor mainDescriptor, JavaBeanDescriptor typeDescriptor) {
    }
    ...
    public String setClassTypeNameProperty(String typeName) {
        if (isClassType()) {
            Object result = setProperty(CLASS_PROPERTY_TYPE_NAME, typeName);
            return result == null ? null : result.toString();
        }
        throw new IllegalStateException("The instance is not a class wrapper");
    }
    ...
    public String getClassTypeNameProperty() {
        if (isClassType()) {
            Object result = getProperty(CLASS_PROPERTY_TYPE_NAME);
            return result == null ? null : result.toString();
        }
        throw new IllegalStateException("The instance is not a class wrapper");
    }
